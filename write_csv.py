...
# Find ALL HTML files including hidden ones (starting with .)
html_files = glob.glob("*") + glob.glob(".*")  # Get all files
html_files = [f for f in html_files if f.endswith('.html')]  # Filter for HTML

# Alternative: Find all files in directory
